...
abstract class $ActorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? profilePath, String name});
}
...
class _$ActorImpl implements _Actor {
  const _$ActorImpl({this.profilePath, required this.name});
  ...
  @override
  String toString() {
    return 'Actor(profilePath: $profilePath, name: $name)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, profilePath, name);
...
abstract class _Actor implements Actor {
  const factory _Actor(
      {final String? profilePath, required final String name}) = _$ActorImpl;
