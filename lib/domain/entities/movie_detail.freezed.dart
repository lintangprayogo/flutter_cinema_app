...
class _$MovieDetailImpl implements _MovieDetail {
  ...
  @override
  String toString() {
    return 'MovieDetail(id: $id, title: $title, overview: $overview, backdropPath: $backdropPath, posterPath: $posterPath, runtime: $runtime, voteAverage: $voteAverage, genres: $genres)';
  }
